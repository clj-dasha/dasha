...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_14599 = (0);while(true){
var m_14600 = cljs.core.async.impl.dispatch.tasks.pop();if((m_14600 == null))
{} else
{m_14600.call(null);
if((count_14599 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__14601 = (count_14599 + (1));
count_14599 = G__14601;
continue;
}
} else
{}
...
{}
cljs.core.async.impl.dispatch.queue_dispatcher = (function queue_dispatcher(){if(cljs.core.truth_((function (){var and__3597__auto__ = cljs.core.async.impl.dispatch.queued_QMARK_;if(and__3597__auto__)
