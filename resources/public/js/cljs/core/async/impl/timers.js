...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + (1))));var i_14506 = (0);while(true){
if((i_14506 < arr.length))
{(arr[i_14506] = null);
{
...
{var i_14513 = (self__.level + (1));while(true){
if((i_14513 <= (new_level + (1))))
{(update[i_14513] = self__.header);
{
var G__14514 = (i_14513 + (1));
i_14513 = G__14514;
continue;
}
} else
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.call(null,self__.header,k,self__.level,update);var x__$1 = (x.forward[(0)]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_14515 = (0);while(true){
if((i_14515 <= self__.level))
{var links_14516 = (update[i_14515]).forward;if(((links_14516[i_14515]) === x__$1))
{(links_14516[i_14515] = (x__$1.forward[i_14515]));
{
var G__14517 = (i_14515 + (1));
i_14515 = G__14517;
continue;
}
} else
{{
var G__14518 = (i_14515 + (1));
i_14515 = G__14518;
continue;
}
}
...
*/
cljs.core.async.impl.timers.timeout = (function timeout(msecs){var timeout__$1 = ((new Date()).valueOf() + msecs);var me = cljs.core.async.impl.timers.timeouts_map.ceilingEntry(timeout__$1);var or__3609__auto__ = (cljs.core.truth_((function (){var and__3597__auto__ = me;if(cljs.core.truth_(and__3597__auto__))
{return (me.key < (timeout__$1 + cljs.core.async.impl.timers.TIMEOUT_RESOLUTION_MS));
} else
{return and__3597__auto__;
}
})())?me.val:null);if(cljs.core.truth_(or__3609__auto__))
...
cljs.core.async.impl.dispatch.queue_delay.call(null,((function (timeout_channel,or__3609__auto__,timeout__$1,me){
return (function (){cljs.core.async.impl.timers.timeouts_map.remove(timeout__$1);
return cljs.core.async.impl.protocols.close_BANG_.call(null,timeout_channel);
});})(timeout_channel,or__3609__auto__,timeout__$1,me))
,msecs);
